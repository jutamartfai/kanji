...
class Practice extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'question' => 'ไฟล์รูปภาพที่ใช้เป็นคำถาม (ใช้เป็นไฟล์ที่มีนามสกุล .jpg, .png และ .gif และมีขนาดที่เหมาะสมคือ 100x40 พิกเซล)',
            'meaning' => 'ไฟล์รูปภาพที่ใช้เป็นคำตอบที่เป็นความหมาย (ใช้เป็นไฟล์ที่มีนามสกุล .jpg, .png และ .gif และมีขนาดที่เหมาะสมคือ 100x40 พิกเซล)',
            'pron' => 'ไฟล์รูปภาพที่ใช้เป็นคำตอบที่เป็นคำอ่านตัวอักษร (ใช้เป็นไฟล์ที่มีนามสกุล .jpg, .png และ .gif และมีขนาดที่เหมาะสมคือ 100x40 พิกเซล)',
        ];
    }
